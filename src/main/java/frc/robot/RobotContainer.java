...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    */
    ...
    operator.axisLessThan(XboxController.Axis.kLeftY.value, -0.15).whileTrue(new ElevatorUp(Elevator, XboxController.Axis.kLeftY.value));
    operator.axisGreaterThan(XboxController.Axis.kLeftY.value, 0.15).whileTrue(new ElevatorDown(Elevator, XboxController.Axis.kLeftY.value));
